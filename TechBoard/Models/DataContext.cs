    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Post>().HasData(new Post[] {
                new Post{Id=1, Title="Nvidia", TextBody="Nvidia blabalbla", ThreadRefId=1 },
                new Post{Id=2, Title="Windows", TextBody="Windows blabalbla", ThreadRefId=2 },
                new Post{Id=3, Title="Shaman", TextBody="Shaman blabalbla", ThreadRefId=3 },
            });
        }
    }
}
